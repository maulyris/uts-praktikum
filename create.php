                ...
                <div class="col-md-12">
                    ...
                    <form action="create.php" method="post" name="form1">
                        ...
                        <div class="form-group">
                         ...
                         <button class="btn btn-success" type="submit" name="Submit" value="Add">Tambah</button>
...
<?php
    ...
    if(isset($_POST['Submit'])) {
        ...
        $result = mysqli_query($conn, "INSERT INTO acara(nama_acara, tanggal_acara, jenis_acara) VALUES('$nama_acara','$tanggal_acara','$jenis_acara')");
